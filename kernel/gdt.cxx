...
: nullSegementSelector(0,0,0),
  ...
  codeSegementSelector(0,64*1024*1024,0x9A),
  dataSegementSelector(0,64*1024*1024,0x92)
 {
    uint32_t i[2];
    i[0] = (uint32_t)this;
...
uint16_t GlobalDescriptorTable::getDataSegementSelector(){
    return (uint8_t*)&dataSegementSelector - (uint8_t*)this;
}

uint16_t GlobalDescriptorTable::getCodeSegementSelector(){
    return (uint8_t*)&codeSegementSelector - (uint8_t*)this;
}
